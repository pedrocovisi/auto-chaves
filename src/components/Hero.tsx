    ...
    return (
        ...
        <section className="relative bg-slate-900 h-[500px] md:h-[650px] flex items-center">
            ...
            <div className="absolute inset-0 z-0 overflow-hidden">
                <img
                    src="https://lh3.googleusercontent.com/p/AF1QipPVC39k4-gztBtuDZ7ot1wWqaeM_s4EYUgoHLGT=s680-w680-h510-rw"
                    alt="Chave de carro na mão"
                    className="w-full h-full object-cover object-top opacity-30 md:opacity-40" // Opacidade baixa para escurecer a foto
                />
            ...
            <div className="relative z-10 max-w-5xl mx-auto px-4 text-center text-white mt-10">
                ...
                <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight leading-tight mb-6 drop-shadow-lg">
                    ...
                    <span className="text-yellow-400">Nós chegamos rápido.</span>
                </h1>

                {/* Subtítulo (P) */}
                <p className="text-lg md:text-2xl text-slate-200 mb-10 max-w-3xl mx-auto font-medium drop-shadow">
                    Especialista em abertura de autos, chaves codificadas e presenciais. Atendimento 24h em toda a região.
                </p>
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-4 px-4">
                    ...
                    <a href="" className="group flex items-center justify-center gap-3 bg-yellow-600 hover:bg-yellow-700 text-white px-8 py-5 rounded-full font-bold text-lg md:text-xl transition-all hover:scale-105 shadow-lg shadow-red-900/50">
                        <FaPhoneAlt className="" /> Agende agora
                    </a>
                    ...
                    <a href="https://wa.me/" target="_blank" className="flex items-center justify-center gap-3 bg-green-600 hover:bg-green-700 text-white px-8 py-5 rounded-full font-bold text-lg md:text-xl transition-all hover:scale-105 shadow-lg shadow-green-900/50">
                        <FaWhatsapp size={28} /> Orçamento no Zap
                    </a>
